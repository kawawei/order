...
const tableSchema = new mongoose.Schema({
  ...
  uniqueCode: {
    ...
    index: true // 建立索引提升查詢效率 - Index for better query performance
  },
  customerUrl: {
    type: String,
    required: false // 由 pre-save 中間件生成 - Generated by pre-save middleware
...
tableSchema.index({ uniqueCode: 1 }); // 快速查詢特定桌次 - Fast lookup by unique code
...
tableSchema.methods.generateUniqueCode = function() {
  ...
  return `${this.merchant}_${this.tableNumber}_${timestamp}_${randomString}`;
};
